...
def make_model(n):
    ...
    # First real layer.
    conved = keras.layers.SpatialDropout1D(rate=1 / dropout_lower)(
        relu()(
            Conv1D(filters=2 * 4 * drops * 2 * 46, kernel_size=9, padding="same")(
                embedded
            )
        )
    )
    ...
    for i in range(0, 5):
        conved = keras.layers.SpatialDropout1D(rate=1 / dropout_lower)(
            relu()(
                Conv1D(filters=2 * 4 * 46, kernel_size=1, padding="same")(
                    concatenate(
                        [
                            clears[-1],
                            keys[-1],
                                ...
                                relu()(
                                    concatenate(
                                        [
                                            ...
                                            MaxPooling1D(
                                                strides=1, padding="same", pool_size=3
                                            )(
                                                Conv1D(
                                                    filters=46,
                                                    kernel_size=1,
                                            ...
                                            #           ),
                                            MaxPooling1D(
                                                strides=1, padding="same", pool_size=7
                                            )(
                                                Conv1D(
                                                    filters=46,
                                                    kernel_size=1,
                                            ...
                                            #            ),
                                            MaxPooling1D(
                                                strides=1, padding="same", pool_size=11
                                            )(
                                                Conv1D(
                                                    filters=46,
                                                    kernel_size=1,
...
callbacks_list = [
    ...
    keras.callbacks.ReduceLROnPlateau(
        patience=3, factor=0.5, verbose=1, min_delta=0.0001
    ),
