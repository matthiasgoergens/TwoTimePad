...
def make_model_conv_res(hparams):
    ...
    def conv(i):
        ...
        return tf.recompute_grad(sequential(*seq))
    ...
    clear = pre_clear = Layer(name="clear", dtype="float32")(make_end(convedA))
    ...
    dev = ShiftLayer(pre_clear, key, inputA)
...
weights_name = "both 20 recompute_grad2.h5"
