...
def make_model_conv_res(hparams):
    ...
    clear = Average(name='clear', dtype='float32')([pre_clear, JustShift(dtype='float32')([key, inputB])])
    ...
    model.compile(
        ...
        loss_weights={"clear": 2 / 2, "key": 0 / 2},
        metrics=[error],
    )
    return model
...
weights_name = "avgpool 20 recompute_grad.h5"
