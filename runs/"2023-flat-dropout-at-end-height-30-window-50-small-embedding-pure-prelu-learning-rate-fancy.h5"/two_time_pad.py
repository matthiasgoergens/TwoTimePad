...
weights_name = "2023-flat-dropout-at-end-height-30-window-50-small-embedding-pure-prelu-learning-rate-fancy.h5"
...
def main(predict_only=False):
    ...
    with tf.device(device_name):
        ...
        callbacks_list = [
            ...
            EarlyStopping(
                monitor="epoch_loss", patience=60, verbose=1, restore_best_weights=True
            ),
        ]
