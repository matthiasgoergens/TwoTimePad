...
def make_model_conv(hparams):
    ...
    embeddingA = tf.keras.backend.one_hot(inputA, 46)
    embeddingB = tf.keras.backend.one_hot(inputB, 46)
...
hparams = {
    ...
    HP_blowup: 2,
    HP_max_kernel: 5,
    HP_deviation_as_loss: 0/20,
}

weights_name = "conv-30-deviation-as-0p0_loss--base4x46-one_hot_embed.h5"
