...
weights_name = "2023-learn-rate.h5"
...
def main(predict_only=False):
    ...
    with tf.device(device_name):
        ...
        checkpoint = ModelCheckpoint(
            "weights/" + weights_name, monitor="val_loss", verbose=1, save_best_only=True
        )
        ...
        callbacks_list = [
            ...
            EarlyStopping(
                monitor="val_loss", patience=60, verbose=1, restore_best_weights=True
            ),
        ]
